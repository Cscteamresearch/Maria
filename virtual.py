...
if __name__ == '__main__':
    ...
    while True:
       ...
       # speak("Tell me how can I help you?") or
        ...
        if "tell me about universirty of abuja" in statement or "what do you know about university of abuja" in statement:
...
if "tell me about the vision of university of abuja" in statement:
...
if " tell me about the mission" in statement or "what is the mission of the university" in statement:
